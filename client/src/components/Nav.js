...
const Nav = () => {
  ...
  return (
    ...
    {/* <!-- LOGO --> */}
    <div className="logo"><Link to="/">          <h2 className="text-2xl font-bold text-white">WATCHES</h2>
         </Link></div>
    ...
    <ul className="nav-links">
      ...
      <div className="menu">
        ...
        {
          Auth() ?   <li onClick={Logout} ><Link>Logout</Link></li> :   <li><Link to="/login">Login</Link></li>
        }
