          ...
          <form className="mt-4 space-y-4 lg:mt-5 md:space-y-5" action="#">
              ...
              <div className="flex items-start">
                  ...
                  <div className="ml-3 text-sm">
                    <label htmlFor="newsletter" className="font-light text-gray-500 dark:text-gray-300">I accept the <Link className="font-medium text-primary-600 hover:underline dark:text-primary-500" >Terms and Conditions</Link></label>
                  </div>
              </div>
